...
namespace Improvar.Controllers
{
    public class TrackingController : Controller
    {
        ...
        //}
        [HttpPost]
        public ActionResult SaveTracking(string apikey, string USERID, string MODULECD, string SESSIONNO, string LAT, string LNG, string CALLFRM, string TRACKTYPE, string REMARKS, string AndroidId = "", string LOGDT = "")
        {
            try
            {
                //// 🔐 API KEY CHECK
                ...
                // 💾 Save
                string res = masterHelp.SaveLocation(LAT.ToString(), LNG.ToString(), TRACKTYPE, USERID, "IPSMART_ESS", SESSIONNO, CALLFRM, REMARKS, LOGDT, AndroidId);
