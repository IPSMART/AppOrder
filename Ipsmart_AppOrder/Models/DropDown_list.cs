...
namespace Improvar.Models
{
    ...
    public class Database_Combo6
    {
        public string FIELD_VALUE { get; set; }
    }
    public class Database_Combo7
    {
        public string FIELD_VALUE { get; set; }
    }
    public class User
    ...
    public class DropDown_list_Batchwise
    {
        public string Text { get; set; }
        public string Value { get; set; }
    }
    ...
    public class DropDown_list_BRGRP
    {
        public string text { get; set; }
        public string value { get; set; }
    }
