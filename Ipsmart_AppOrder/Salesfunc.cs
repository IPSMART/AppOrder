...
namespace Improvar
{
    public class Salesfunc : MasterHelpFa
    {
        ...
        public DataTable GetDistributor(string tdt, string SLMSLCD)
        {
            ...
            string sql = "";
            sql += "select a.slmslcd, a.DISTSLCD , b.slnm DISTSLnm, nvl(b.slarea, b.district) slarea, nvl(b.WHATSAPP_NO,b.REGMOBILE)WHATSAPP_NO, b.regemailid from " + Environment.NewLine;
