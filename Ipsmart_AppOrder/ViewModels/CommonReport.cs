...
//        public List<DropDown_DOCCD> DropDown_DOCCD { get; set; }
...
//        public List<DropDown_Grid_COLUMN> AvailableColumn { get; set; }
//        public List<DropDown_Grid_COLUMN> SelectedColumn { get; set; }
//        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:dd/MM/yyyy}")]
