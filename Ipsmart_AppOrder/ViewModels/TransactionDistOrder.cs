...
{
    public class TransactionDistOrder : Permission
    {
        ...
        public T_DISTORDER T_DISTORDER { get; set; }
        [StringLength(50)]
        public string ITREM { get; set; }

        public List<ListPendOrd> ListPendOrd { get; set; }
        public List<ListPendOrdPopup> ListPendOrdPopup { get; set; }
